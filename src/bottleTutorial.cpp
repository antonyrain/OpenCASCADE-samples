...
{
    const Standard_Real myWidth = 100; 
    const Standard_Real myHeight = 150;
    const Standard_Real myThickness = 70;
    ...
    //Write the model to a STEP file
	STEPControl_Writer writer;
	writer.Transfer(aRes,STEPControl_AsIs);
	writer.Write("model.stp");

 	std::cout << "Created STEP file: model.stp" << std::endl;
	...
	std::cout << "Created STL file: model.stl" << std::endl;
